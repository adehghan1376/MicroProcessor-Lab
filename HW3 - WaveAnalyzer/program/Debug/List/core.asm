...
_0x0:
	.DB  0x25,0x20,0x64,0x0,0x25,0x20,0x66,0x0
	.DB  0x20,0x20,0x20,0x42,0x4F,0x4F,0x54,0x49
	.DB  0x4E,0x47,0x20,0x55,0x50,0x20,0x20,0x20
	.DB  0x0,0x20,0x20,0x20,0x20,0x47,0x52,0x4F
	.DB  0x55,0x50,0x20,0x23,0x31,0x20,0x20,0x20
	.DB  0x20,0x0,0x4F,0x0,0x58,0x0,0x23,0x0
	.DB  0x46,0x72,0x65,0x71,0x75,0x65,0x6E,0x63
	.DB  0x79,0x0,0x20,0x20,0x20,0x20,0x20,0x20
	.DB  0x20,0x20,0x0,0x45,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2040060:
	.DB  0x1
...
; 0000 0108             inputCaptureData = a - b;
	...
	SUB  R30,R6
	SBC  R31,R7
	STS  _inputCaptureData,R30
	STS  _inputCaptureData+1,R31
; 0000 0109             if(inputCaptureData < 0 )
	LDS  R26,_inputCaptureData
	LDS  R27,_inputCaptureData+1
; 0000 010A             {
...
SUBOPT_0x4:
	LDS  R30,_inputCaptureData
	LDS  R31,_inputCaptureData+1
	CLR  R22
	CLR  R23
	CALL __CDF1
	RET
