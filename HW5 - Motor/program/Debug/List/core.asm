...
; 0000 0016 // Function: Bit7=In Bit6=In Bit5=Out Bit4=Out Bit3=Out Bit2=In Bit1=In Bit0=In
; 0000 0017 DDRB=(0<<DDB7) | (0<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(56)
	OUT  0x17,R30
; 0000 0018 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=T Bit1=T Bit0=T
...
; 0000 002A // Mode: Phase correct PWM top=0xFF
; 0000 002B // OC0 output: Non-Inverted PWM
; 0000 002C TCCR0=(1<<WGM00) | (1<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(97)
	OUT  0x33,R30
...
_0x3:
; 0000 007A 
; 0000 007B         if(PINC.0 == 1){
	SBIS 0x13,0
	RJMP _0x6
; 0000 007C             if(speed < 255)
	LDI  R30,LOW(255)
	LDI  R31,HIGH(255)
	CP   R4,R30
	CPC  R5,R31
	BRGE _0x7
; 0000 007D                 speed = speed + 1;
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
; 0000 007E         }
_0x7:
; 0000 007F         if(PINC.1 == 1){
_0x6:
	SBIS 0x13,1
	RJMP _0x8
; 0000 0080             if(speed > -255)
	LDI  R30,LOW(65281)
	LDI  R31,HIGH(65281)
	CP   R30,R4
	CPC  R31,R5
	BRGE _0x9
; 0000 0081                 speed = speed - 1;
	MOVW R30,R4
	SBIW R30,1
	MOVW R4,R30
; 0000 0082         }
_0x9:
; 0000 0083 
; 0000 0084         if(speed>0){
_0x8:
	CLR  R0
	CP   R0,R4
	CPC  R0,R5
	BRGE _0xA
; 0000 0085             OCR0 = speed;
	OUT  0x3C,R4
; 0000 0086             PORTB.4 = 1;
	SBI  0x18,4
; 0000 0087             PORTB.5 = 0;
